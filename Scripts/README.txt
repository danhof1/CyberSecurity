...
Select Directories works like this:
-You run the program and it adds those custom files to cache and customScan.txt
-You can run Select Files again and it will wipe Cache and then allow you to select a
whole new batch of files to send to CustomScan.txt
